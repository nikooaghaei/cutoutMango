...
**using model label or true label doesn't differ much as we are using a pre-trained res18 with final training accuracy of 99.992 which means its orediction would be wrong for ~4 images.